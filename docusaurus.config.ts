...
const config: Config = {
  ...
  organizationName: 'flabat', // Usually your GitHub org/user name.
  projectName: '0x4c', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Fabian Labat, Inc. Built with Docusaurus.`,
    },
    prism: {
